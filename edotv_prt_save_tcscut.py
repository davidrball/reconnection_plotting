...
for part_num in range(min_part_num,max_part_num,partskip):
    ...
    print('taking t from:',tlow, tup)

    target = open('edotv_prtls/bguide.3_untriggered_hightimeres_latetime/tcs_cut/'+str(part_num)+'txt','w')
    #target = open('edotv_prtls/bguide.3_triggered_hightimeres_nothresh/tcs_cut/'+str(part_num) + '.txt','w')
    target.write('proc, ind, tcs,finalgam,t , u , v , w , ex , ey , ez , bx , by , b\
z , gamma')
    target.write('\n')
