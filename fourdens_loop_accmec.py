...
#ax1.set_yticks([-1,-.5,0,.5,1])
    ...
    ax0.annotate("$B_{g}/B_{0}=0$",(-.3,.25),color="White",size=14,fontweight='bold')
    ax1.annotate("$B_{g}/B_{0}=0$",(-.3,.25),color="White",size=14,fontweight='bold')    
    ax2.annotate("$B_{g}/B_{0}=0.3$" ,(-.4,.25),color="White",size=14,fontweight='bold')
    ax3.annotate("$B_{g}/B_{0}=0.3$",(-.4,.25),color="White",size=14,fontweight='bold')
...
#ax3.annotate("c)",(-2.7,.4),color="Black",size=14)
    ...
    #ax0.set_ylabel('y ($1000\;c/\omega_{p}$)',size=12)
    ax1.set_ylabel('y ($1000\;c/\omega_{p}$)',size=14)
    ax1.yaxis.set_label_coords(-.15,-.13)
    for ax in fig.axes:
        plt.sca(ax)
        plt.yticks(fontsize=10)#, rotation=90)
    #ax2.set_ylabel('y ($1000\;c/\omega_{p}$)',size=12)
    #ax3.set_ylabel('y ($1000\;c/\omega_{p}$)',size=12)
...
#cbar_ax = fig.add_axes([.81, .12, .05, .75])
    ...
    cbar_ax = fig.add_axes([.3,.93,.425,.02])
...
#cb.ax.set_xticklabels([0,4,8,12,16,20])
    ...
    fig.savefig('accmec_fourdens'+t_str+'.png',dpi=300,bbox_inches='tight')
    '''
    plt.figure()
    ax = plt.gca()
