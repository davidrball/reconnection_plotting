...
#bguide triggered
mybase = "../../tristan_acc-mec_Ez/highbeta_example/output/"
...
savename = "final_plots/highbeta_accmec"


#don't need this if we're not doing the spectra saving
spect_filepath = "highbeta"
filepath = "classification_txt/highbeta.txt"  
