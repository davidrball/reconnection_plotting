...
fig, ((ax0, ax1, ax2, ax3), (ax4, ax5, ax6, ax7), (ax8, ax9, ax10, ax11), (ax12, ax13, ax14, ax15)) = plt.subplots(4,4,gridspec_kw={'hspace':.05})
...
plt.savefig('4x4_flds_testspace.png',dpi=300,bbox_inches='tight')
