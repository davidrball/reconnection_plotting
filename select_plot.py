...
#for testing midrange energy prtls
gam = 100
gamscan = .1
new_bool_array = gammae> gam-gamscan
new_bool_array2 = gammae < gam+gamscan
bool_array_comb = new_bool_array*new_bool_array2
...
for t in range(t0, tf):
    ...
    ax2.set_ylim(1,1e4)
    ax3.set_ylim(0,.25)
    plt.savefig('gam100_select/tracks/'+tstr+'.png',dpi=300,bbox_inches='tight')
    plt.close()
    myfld.close()
    myprt.close()
