...
#fld_base0 = "../../tristan-mp_reconnection/16k_triggered_finals/sig.3/delgam0005/output/flds.tot.00"

fld_base1 = "../../tristan-mp_reconnection/guide_fields/sig.1/simulation_matrix/delgam000165/bguide1/output/flds.tot.0"

fld_base0 = "../../tristan-mp_reconnection/guide_fields/sig.1/simulation_matrix/delgam000165/bguide.1/output/flds.tot.0"
...
#ax3.annotate("c)",(-2.7,.4),color="Black",size=14)
    ...
    ax1.set_xlabel('x ($1000\;c/\omega_{p}$)',size=14)
...
#cb.ax.set_xticklabels([0,4,8,12,16,20])
    ...
    fig.savefig('sig.1_flds.png',dpi=300,bbox_inches='tight')
    '''
    plt.figure()
    ax = plt.gca()
