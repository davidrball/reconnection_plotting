...
myhist, xedges, yedges, image = plt.hist2d(np.log10(np.abs(wpar_final)), np.log10(gammae_final),bins=(wparbins,gambins),norm=LogNorm(vmin=100,vmax=1e5),cmin=10)
#plt.xscale('log')
#plt.yscale('log')
#plt.xlim(1e2,2e3)
...
plt.savefig('testing_2dhist_pleiades.png',dpi=300,bbox_inches='tight')
plt.close()
