...
matrix30 = "/home/u21/davidrball/david/tristan-mp_reconnection/guide_fields/sig.3/simulation_matrix/delgam00005/bguide.7/output/flds.tot."
...
matrix43 = "/home/u21/davidrball/david/tristan-mp_reconnection/guide_fields/sig.3/simulation_matrix/delgam05/bguide1/output/flds.tot."
...
matrix_namelist = [[matrix00, matrix01, matrix02,matrix03], [matrix10,matrix11,matrix12,matrix13], [matrix20,matrix21,matrix22,matrix23],[matrix30,matrix31,matrix32,matrix33],[matrix40, matrix41, matrix42, matrix43]]
    ...
    for j in range(3,4):
        if matrix_namelist[i][j] == "pass":
            ...
            for t in range(t_start, t_final):
                ...
                xpoint_countlist[i][j].append(num_xpoints+num_plasmoids)
                myf.close()
#for i in range(len(matrix_namelist)):
...
for i in range(4,5):
    for j in range(3,4):
        if matrix_namelist[i][j] == "pass":
            ...
            name = 'plasmoid_xpoint_txt/' + str(i) + str(j)
            target = open(name,'w')
